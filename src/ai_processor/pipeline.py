...
class Pipeline:
    ...
    def __init__(
        ...
        llm_model: Optional[str] = MISTRAL_MODEL_NAME,
        ...
        if not self.mistral_api_key:
            raise ValueError("Mistral API key is required. Set it in the environment or pass it as an argument.")
        self.llm_model = llm_model or Config.MISTRAL_MODEL_NAME
        self.debug = debug
...
if __name__ == "__main__":
    ...
    extracted_paths = pipeline.extract_sheets_to_pdf(pdf_filename_test)
